import cfg.schueler;
import cfg.lehrer;
import cfg.schulhaus;
import welt.virus.COV19;
import getraenk.kaffee;
import getraenk.clubmate;

public class Kursbericht {

    public static void main(String[] args) {
        /* no comment */

        schueler hackerman = new schueler();
        lehrer straeten = new lehrer("Straeten");

        while (hackerman.ABITUR_cannot_be_found()) {
            if (hackerman.class == 10) {
                /*
                Um in das Pilotprojekt "Informatik für Dullis" am CFG zu kommen musste man ähnlich zum KSK oder der GSG9 ein hartes Einstellungsverfahren absolvieren.
                Es bestand aus 25 Kilobyte Fitness-Surf-Test und einem Hardwarecheck auf Prozessor und Platine. Da dieser einfach viel zu simpel war, hatten wir auch Teilnehmer,
                welche es wiederholt geschafft haben, den USB-Stick in den Netzwerk-Port zu stecken. Dennoch bestand diese Arbeitsgemeinschaft aus +- 20 wissbegierigen Schülern.
                Abschließend sollte eine gemeinsame Exkursion zu einem Workshop bei SAP stattfinden. Dieser startete im allseits bekanntem Inspirationpavilion und endete in einem Raum voller Computer und Hackermans.
                Diese bekamen die Aufgabe, sich Wissen zum Thema HTML/CSS anzueignen. Da einigen hochleistungs-Hackermans diese Aufgabe etwas zu langweilig war. Aufgrund zu viel Vorerfahrung, endete es in n + 1 offenen Tabs
                (hierbei ist n nicht zählbar und die Anzahl der offenen Tabs *hust* Rekursion ohne Abbruchbedingung *hust* (Um Rekursion zu verstehen, muss man zunächst Rekursion verstehen!)).
                 */
                hackerman.class++;
            }
            if (hackerman.class == 11) {
                /*
                ...
                Allerdings gab es immer wieder kleine Hoffnungsfunken, wenn man sich in den Tiefen des Internets (google-Suche Seite 2, auf der die ganzen Leichen versteckt werden) bewegte.
                Dank unseres Fitness-Surf-Test und weiteren Trainingseinheiten waren wir in der Lage auch mal über den Rand der ersten Google-Suchseite hinaus zu blicken.
                An dieser Stelle, danke an das Internet für zahlreichen Informatikseiten und der Copy-Paste-Funktion *hust* stackoverflow *hust*.
                Doch die Copy-Paste Funktion ließ uns auch immer wieder etwas Lernen, und der Unterricht von Frau Straeten natürlich auch, was auch zu etwas erfolgreicheren Projekten führte.
                Wir schafften es sogut wie jeden bekannten Sortieralgorithmus in unserer Lieblingssprache Java und der noch viel beliebteren Umgebung BlueJ zu implementieren.
                Aufgrund dieser enormen Lernbegeisterung waren wir auch in weiteren Informatikwettbewerben vertreten, wie z.B. (alles Wettbewerbe die eh keiner googelt (gibts das Wort googelt?)).
                Diese Einzelwettbewerbe wurden wegen der guten Breitbandanbindung zwischen den Hackermans im Team DATENBACH meist eher zusammen gelöst. Ein Hackerman war besonders schnell bei diesen Wettbewerben.
                Er war nach 20 von 45 Minuten fertig. Dieser teilte Brüderlich/Schwesterlich seine Lösungen. Aber das weiß ja eh niemand bis auf unser FBI-Agent, der jedesmal weinend auf seinem Stuhl saß.
                Das tat manchmal auch Frau Straeten wenn sie unsere, auf Papier geschriebenen, Implementierungen in den Klausuren korrigieren musste.
                */
                COV19.activate();
                /*
                Noch dazu sollte das Leben der 11 Hackermans und das von Frau Straeten durch einen sehr brutalen Virus beeinträchtigt werden. Er war in der Lage, sämtliche Schutzsysteme zu umgehen und machte es unmöglich,
                dass sich die Arbeitsgemeinschaft der Hackermans ihrem Gemeinschaftskeller treffen konnte. Doch die digitalen Fähigkeiten machten es den Hackermans im Vergleich zu dem Rest der Schule deutlich einfacher,
                die Arbeitsgeschmeinschaftstreffen online stattfinden zu lassen um so den Lernprozess nicht zu schädigen. Allerdings war diese Form des Unterrichts für alle meist sehr viel anstrengender als vorher.
                Aber trotz aller Soft-und Hardwarebelastung überlebten die 11 Hackermans und die eine dazugehörige Lehrerin das Schuljahr.
                 */
                hackerman.class++;
            }
